...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if (this.state.touched.firstname && firstname.length < 3)
            ...
            errors.firstname = 'First name should not contain more than 10 characters';

        if (this.state.touched.lastname && lastname.length < 3)
            errors.firstname = 'Last name should have atleast 3 characters';
        else if (this.state.touched.lastname && lastname.length > 10)
            errors.firstname = 'Last name should not contain more than 10 characters';

        const reg = /^\d+$/;
        if (this.state.touched.telnum && !reg.test(telnum) && telnum.length < 10)
            errors.telnum = "Tel. number should contain only numbers and 10 digit";
