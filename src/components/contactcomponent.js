...
class Contact extends Component {
    ...
    render() {
        return ( <
            ...
            show = "touched"
            messages = {
                { required: 'Required', minlength: 'Must be greater than 2 characters', maxLength: 'Must be less than 15 characters or less' }
            }
            /> < /
            Col > <
            /Row> <
            ...
            show = "touched"
            messages = {
                { required: 'Required', minlength: 'Must be greater than 2 numbers', maxLength: 'Must be less than 15 numbers' }
            }
            /> < /
            Col > <
            /Row> <
